#Exercice1
#1
setwd("L:/BUT/SD/Promo 2023/acordier/Progra statistiques/datasets/nba")
getwd()
#2
...
assign(x = nom_fichier_sans_extension, value = read.csv(fichiers[1], sep = ",", dec = "."))
...
dfJoin = merge(x = df_x, y = df_y, by = "game_id",all.x = TRUE )
